...
public class EntityScriptCondition extends ScriptCondition<EntityTag> implements IEntityCondition {
    ...
    public boolean check(AbstractEntity abstract_entity) {
        return check(new EntityTag(abstract_entity.getBukkitEntity()));
    }
}
